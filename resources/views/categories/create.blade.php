    ...
    <div class="container py-5">
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Creer une categorie</li>
            </ol>
        </nav>
                        ...
                        <form action="{{ route('admin.categories.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" rows="4"
                                    ...
                                    placeholder="Usage, style, caracteristiques...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg">
                                    <i class="bi bi-check-circle me-2"></i>Creer la categorie
                                </button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="alert alert-info mt-4 border-0" role="alert">
                    <div class="d-flex">
                        ...
                        <div>
                            ...
                            <p class="mb-0 mt-1">Choisissez un nom court et clair. Le slug est genere automatiquement.</p>
                        </div>
                    </div>
                </div>
            </div>
