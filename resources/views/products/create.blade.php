                        ...
                        <form action="{{ route('products.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}"
                                    ...
                                    placeholder="Ex: Laptop Dell XPS 13" required>
                                @error('name')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    <label for="category_id" class="form-label fw-semibold">
                                        <i class="bi bi-box me-2 text-primary"></i>Category_id
                                    </label>
                                    <input type="number" name="category_id" id="category_id" value="{{ old('category_id') }}"
                                        class="form-control @error('category_id') is-invalid @enderror" placeholder="Quantité disponible" min="0" required>
                                    @error('category_id')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch p-0">
                                    ...
                                    <small class="d-block text-muted mt-1 ms-4">Activez cette option pour rendre le produit
                                        visible dans votre boutique</small>
                                </div>
                            </div>
                ...
                <div class="alert alert-info mt-4 border-0" role="alert">
                    <div class="d-flex">
                        ...
                        <div>
                            ...
                            <p class="mb-0 mt-1">Assurez-vous que tous les champs sont correctement remplis. Le produit sera
                                ajouté à votre catalogue une fois le formulaire validé.</p>
                        </div>
                    </div>
                </div>
            </div>
